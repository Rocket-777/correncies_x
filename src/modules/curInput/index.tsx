import {StyledTextField, InputBase, CurrLabel, TextFieldContainer,
    MenuProps, StyledSkeleton} from "./styles";
...
export const CurInp: FC<ICurInpProps> = ({type}) => {
    ...
    if (!currState.isLoading) {
        ...
        if (type === 'to') return (<InputBase size='small'>
                ...
                <TextFieldContainer>
                    <StyledTextField aria-readonly value={isNaN(toValue) ? '' : toValue}/>
                    <CurrLabel>
